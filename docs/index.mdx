...
1. [X] Render background element
2. [X] Add grid background element
3. [ ] Flesh out canvas item API
	1. [ ] Click detection
	2. [ ] Canvas item selection
4. [ ] Flesh out brush API
5. [ ] Add UI controls for brush selection
